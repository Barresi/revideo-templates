...
import { all, createRef, createSignal, makeProject, Reference, useScene, waitFor } from '@revideo/core';
import './global.css';
...
const scene = makeScene2D('topBottomScene', function* (view) {
  ...
  // Wait a frame then adjust video scaling manually
  yield;
